...
/*   Updated: 2024/10/31 13:09:20 by lpolizzi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Execute single moves for `a` and `b`
void do_single_moves(t_stack_pair **stacks, int *moves_a, int *moves_b, t_op_list **list);

// Execute multiple moves for `a` and `b` together
void do_multiple_moves(t_stack_pair **stacks, int *moves_a, int *moves_b, t_op_list **list);

// Perform moves to push the node with lowest cost
void do_moves(t_stack *node, t_stack_pair **stacks, t_op_list **list, int direction);
